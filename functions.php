...
add_action('wp_enqueue_scripts', 'rosehill_scripts', 100);
function rosehill_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'rosehill-scripts', 
    get_template_directory_uri() . '/js/rosehill-scripts.js', 
    array('jquery'), 
    '', 
    true
  ); 
  ...
  wp_enqueue_script('rosehill-scripts'); 
  
}

add_action('wp_enqueue_scripts', 'rosehill_styles');
function rosehill_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('google-fonts', '//fonts.googleapis.com/css?family=Cardo:400,700|Cinzel:700|Lato:400,700,900');
  wp_register_style('fontawesome', '//use.fontawesome.com/releases/v5.1.0/css/all.css');
  wp_register_style('rosehill', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('google-fonts');
  wp_enqueue_style('fontawesome');
  wp_enqueue_style('rosehill');
}
...
function rosehill_header_fallback_menu(){ ?>
  <ul class="nav navbar-nav navbar-right">
    <li<?php if(is_page('hunts')){ echo ' class="active"'; } ?>><a href="<?php echo esc_url(home_url('hunts')); ?>">Hunts</a></li>
...
function rosehill_footer_fallback_menu(){ ?>
  <ul class="list-unstyled list-inline text-center">
    <li><a href="<?php echo esc_url(home_url()); ?>">Home</a></li>
    <li><a href="<?php echo esc_url(home_url('hunts')); ?>">Hunts</a></li>
    <li><a href="<?php echo esc_url(home_url('our-rates')); ?>">Our Rates</a></li>
    <li><a href="<?php echo esc_url(home_url('guides-dogs')); ?>">Guides & Dogs</a></li>
